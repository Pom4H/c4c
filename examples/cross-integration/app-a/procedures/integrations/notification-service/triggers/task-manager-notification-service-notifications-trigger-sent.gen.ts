...
export const TaskManagerNotificationServiceNotificationsTriggerSentContract: Contract = {
  name: "notification-service.task.manager.notification.service.notifications.trigger.sent",
  ...
  metadata: {
    ...
    operation: "taskManagerNotificationServiceNotificationsTriggerSent",
...
export const TaskManagerNotificationServiceNotificationsTriggerSentProcedure: Procedure = {
  contract: TaskManagerNotificationServiceNotificationsTriggerSentContract,
  handler: async () => {
