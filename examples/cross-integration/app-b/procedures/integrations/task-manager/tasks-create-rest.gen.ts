...
export const TasksCreateRestContract: Contract = {
...
const tasksCreateRestHandler = applyPolicies(
  async (input, context) => {
    ...
    const result = await sdk.tasksCreateRest({ 
      body: input,
      headers,
      client: customClient 
    } as any);
...
export const TasksCreateRestProcedure: Procedure = {
  contract: TasksCreateRestContract,
