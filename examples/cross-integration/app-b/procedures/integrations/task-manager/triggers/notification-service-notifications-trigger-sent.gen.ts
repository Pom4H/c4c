...
export const NotificationServiceNotificationsTriggerSentContract: Contract = {
  name: "task-manager.notification.service.notifications.trigger.sent",
  ...
  metadata: {
    ...
    operation: "notificationServiceNotificationsTriggerSent",
...
export const NotificationServiceNotificationsTriggerSentProcedure: Procedure = {
  contract: NotificationServiceNotificationsTriggerSentContract,
  handler: async () => {
