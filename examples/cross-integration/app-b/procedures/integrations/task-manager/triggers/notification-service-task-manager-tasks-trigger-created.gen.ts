...
export const NotificationServiceTaskManagerTasksTriggerCreatedContract: Contract = {
  name: "task-manager.notification.service.task.manager.tasks.trigger.created",
  ...
  metadata: {
    ...
    operation: "notificationServiceTaskManagerTasksTriggerCreated",
...
export const NotificationServiceTaskManagerTasksTriggerCreatedProcedure: Procedure = {
  contract: NotificationServiceTaskManagerTasksTriggerCreatedContract,
  handler: async () => {
