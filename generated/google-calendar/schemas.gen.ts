...
export const CalendarListEntrySchema = {
    properties: {
        accessRole: {
...
export const CalendarNotificationSchema = {
    properties: {
        method: {
...
export const ColorDefinitionSchema = {
    properties: {
        background: {
...
export const ConferenceDataSchema = {
    properties: {
        conferenceId: {
...
export const ConferenceParametersSchema = {
    properties: {
        addOnParameters: {
...
export const ConferenceParametersAddOnParametersSchema = {
    properties: {
        parameters: {
            additionalProperties: {
                type: 'string'
...
export const ConferencePropertiesSchema = {
    properties: {
...
export const ConferenceRequestStatusSchema = {
    properties: {
        statusCode: {
...
export const ConferenceSolutionSchema = {
    properties: {
        iconUri: {
...
export const ConferenceSolutionKeySchema = {
    properties: {
        type: {
...
export const CreateConferenceRequestSchema = {
    properties: {
...
export const EventAttendeeSchema = {
    properties: {
        additionalGuests: {
            default: 0,
...
export const EventDateTimeSchema = {
    properties: {
        date: {
...
export const EventReminderSchema = {
    properties: {
        method: {
...
export const EventWorkingLocationPropertiesSchema = {
    properties: {
        customLocation: {
...
export const FreeBusyCalendarSchema = {
    properties: {
        busy: {
...
export const FreeBusyGroupSchema = {
    properties: {
        calendars: {
...
export const FreeBusyRequestSchema = {
    properties: {
...
export const FreeBusyRequestItemSchema = {
    properties: {
        id: {
...
export const FreeBusyResponseSchema = {
    properties: {
        calendars: {
            additionalProperties: {
